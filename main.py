...
class BinaryHeap:
    ...
    def max_heapify(self, i):
        ...
        if right < self.heapSize and self.data[right] > self.data[temporary]:
            temporary = right

        if left < self.heapSize and self.data[left] > self.data[temporary]:
            temporary = left

        if temporary != i:
            self.data[i], self.data[temporary] = self.data[temporary], self.data[i]
